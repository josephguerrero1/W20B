...
--
-- Host: 34.66.27.25    Database: cli_social_media
-- ------------------------------------------------------
...
INSERT INTO `exploits` VALUES (1,'Restarted the matrix and ended the war between the humans and machines',1),(2,'Awakened Neo from the matrix',2),(3,'Neo\'s ally',3),(4,'A deviant, violent program threatening to destroy both the matrix and robot world',4);
...
INSERT INTO `hackers` VALUES (1,'Neo','neo123'),(2,'Morpheus','morpheus123'),(3,'Trinity','trinity123'),(4,'Agent Smith','smith123');
...
-- Dump completed on 2021-06-16  5:16:25
